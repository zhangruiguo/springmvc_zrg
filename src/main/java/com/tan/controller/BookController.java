...
public class BookController {
	...
	@RequestMapping(value="getzrg")
	public String getzrg( Book book) {
			System.out.println("bookname:" + book.getName());
			System.out.println("author:" + book.getAuthor());
			System.out.println("by zrg");
			bookService.add(book);
	...
	public String Getstr1(){ 
		String output = null;
		try {
			String targetURL = "http://wisdomhunter.tpddns.cn:8081/RESTfulExample/customer/getData";
	...
	@ResponseBody
	@RequestMapping(value = "getmenustr",produces="application/json;charset=UTF-8")
