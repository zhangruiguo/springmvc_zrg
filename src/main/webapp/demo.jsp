...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $.post('<%=request.getContextPath()%>/book/getdata',
           {
        	sql: $('#sqltext').val(),
           },
        ...
        $.post('<%=request.getContextPath()%>/book/getmenustr',{},
                function (data) {
                	$(".menu").html(data);
                	$(".menu").kendoPanelBar({
                        expandMode: "single"
                    });}, "json");
        $.post('<%=request.getContextPath()%>/book?method=select',{},
                function (data) {
                	$(".ht2").html(data);
            }, "json");
                ...
                transport: {
                    read: {
                        url: function (options) {
                            return '<%=request.getContextPath()%>/book/getmenu';
                        },
